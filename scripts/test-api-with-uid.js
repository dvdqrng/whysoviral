// Script to test our API endpoint with a specific UID
const TEST_UID = '6766559322627589000';

async function testApiWithUid() {
  console.log('=== Testing Our API with UID ===');
  ...
  try {
    ...
    // Check if we got an HTML response instead of JSON (indicates wrong port)
    ...
    if (data.success) {
      ...
      console.log('\nTest Passed: The API successfully retrieved actual TikTok data for this UID');
    } else {
